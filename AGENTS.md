...
| Schema                | `src/store/schema.ts`                                                | SQLite schema (tables, indexes, FTS5 table). No triggers (see §3). `initializeDatabase()` function. Schema version 7 (migrates v1→v2→v3→v4→v5→v6→v7).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
